...
public class WalletWrapperMock extends WalletWrapper {
    ...
    @Override
    public boolean sendBitcoinTransaction(List<ECKey> keys, String depositAddress, String amountOfCoin, NetworkParameters network, PeerGroup peerGroup, AbstractBlockChain chain) {
        return true;
    }
}
